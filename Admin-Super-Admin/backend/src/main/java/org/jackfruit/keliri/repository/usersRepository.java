...
public interface usersRepository extends MongoRepository<users, String>{
	...
	@Query(value = "{userType:'PUBLISHER'}", fields="{'fullName':1,'emailAddress':1,'phoneNumber.dialNumber':1,'lastKnownLocation':1}")
	 ...
	 @Query(value="{'givendor':1}",fields="{'fullName':1,'emailAddress':1,'phoneNumber.dialNumber':1,'lastKnownLocation':1,'givendor':1,'accountStatus':1,'latitude':1,'longitude':1}")
