...
public class ad_campaigns {
 ...
 private ObjectId advertisementId;
 private String uid;
 private String createdThrough;
 private dateRange dateRange;
 private ArrayList<ObjectId> campaignCategories;
...
public ArrayList<String> getCampaignCategories() {
	...
	for (ObjectId id : campaignCategories) {
		if (id != null) {
			hexList.add(id.toHexString());
		}
	}
	return hexList;
}
public void setCampaignCategories(ArrayList<String> campaignCategories) {
	if (campaignCategories == null) {
		this.campaignCategories = null;
		return;
	}
	ArrayList<ObjectId> idList = new ArrayList<>();
	for (String hex : campaignCategories) {
		if (hex != null && !hex.isBlank()) {
			idList.add(new ObjectId(hex));
		}
	}
	this.campaignCategories = idList;
}
public String getAdvertisementId() {
	return advertisementId == null ? null : advertisementId.toHexString();
}
public ad_campaigns(String id, org.jackfruit.keliri.model.location location, String compaignsStatus, ObjectId createdBy,
		ObjectId advertisementId, org.jackfruit.keliri.model.dateRange dateRange, ArrayList<String> campaignCategories) {
	super();
	this.id = id;
...
public void setAdvertisementId(ObjectId advertisementId) {
	this.advertisementId = advertisementId;
}
public void setAdvertisementId(String advertisementId) {
	this.advertisementId = advertisementId == null || advertisementId.isBlank() ? null : new ObjectId(advertisementId);
}
...
public String getCreatedBy() {
	return createdBy == null ? null : createdBy.toHexString();
}
public void setCreatedBy(ObjectId createdBy) {
	this.createdBy = createdBy;
}
public void setCreatedBy(String createdBy) {
	this.createdBy = createdBy == null || createdBy.isBlank() ? null : new ObjectId(createdBy);
}
@Override
public int hashCode() {
