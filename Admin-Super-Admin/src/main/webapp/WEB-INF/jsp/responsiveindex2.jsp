...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  ...
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=${googleMapsApiKey}" async defer></script>
...
document.addEventListener("DOMContentLoaded", function() { 
	//console.log('DOM Loaded'+latitudefromsession +'and'+longitudefromsession);
	
	// console.log('vertical enabled : ' +verticalenabled);
